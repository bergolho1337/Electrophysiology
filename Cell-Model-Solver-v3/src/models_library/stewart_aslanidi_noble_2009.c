...
// Reference: https://models.physiomeproject.org/exposure/38cf8387b0707f0ef6947f009710aeb5/stewart_aslanidi_noble_noble_boyett_zhang_2009.cellml/docgen
...
void RHS_cpu(const real *sv, real *rDY_, real stim_current) {
    ...
    // Manually added the stimulus current
    real RATES[NEQ];
