...
run_prepacing () {
    ...
    echo "****************************************************************************************************"
    # Prepacing 
    ./bin/FentonExperiment examples/experiment-2/prepacing:cable-$2_bcl-$1.ini
    cp output.sst steady_state/experiment-2/cable-$2_bcl-$1.sst 
    #./clear_results.sh
    echo "****************************************************************************************************"
}
...
run_simulation () {
    ...
    echo "****************************************************************************************************"
    # Experiment
    ./bin/FentonExperiment examples/experiment-2/cable-$2_bcl-$1.ini
    mkdir scripts/$1ms
...
run_propagation_velocity_calculation () {
    ...
    echo "****************************************************************************************************"
    # Script
    python ./scripts/calc_propagation_velocity.py ./scripts $2 0.01 $1
    echo "****************************************************************************************************"
}
...
CABLE_LENGTHS=("5" "4.5" "4")
OFFSET_100=("100" "90" "80")
OFFSET_400=("400" "360" "320")
NUMBER_TESTS="2"
