...
//
// The PDE related to the diffusion part has been solved using an implicit approach. The linear
// system has been solved by using LU decomposition.
//
...
//	- The first one has the objective of reaching the steady-state of the system (20 stimuli). In the last timestep we
