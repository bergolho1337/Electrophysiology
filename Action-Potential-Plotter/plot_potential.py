...
def main():
	...
	if len(sys.argv) != 4:
		...
		print("-------------------------------------------------------------------------")
		print("Examples:\tpython plot_potential.py inputs/ap-fhn-cell-1000.txt 0.02 100")
		print("         \tpython plot_potential.py inputs/ap-fhn-4aps-cell-1000.txt 0.01 100")
		print("         \tpython plot_potential.py inputs/ap-tt-cell-1000.txt 0.02 100")
		return 1
